        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
             ...
             echo"</center>";
                ...
                // Adicionando o botão de favoritar (ícone de coração) e o formulário associado
                echo "<form class='favorite-form' action='../Favoritas/favoritar_musica.php' method='post'>";
